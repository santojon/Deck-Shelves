...
- **Per-day time-window overrides for smart shelves** — each hour range in a smart shelf's visibility schedule can specify which days it applies to, independently from the shelf-level day filter
