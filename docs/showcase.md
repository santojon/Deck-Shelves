...
| `settings-page.png`, `settings-statistics.png`, `settings-integrations.png`, `settings-advanced.png` | Settings-page tabs (Integrations / Advanced require Advanced mode on) |
