...
from devkit.screenshots.lib.nav import (
...
from devkit.screenshots.lib.capture import capture_bigpicture, capture_qam
...
def shelf_edit_filters(sjc: Session, host: str, port: int, out_dir: Path) -> Dict[str, Path]:
    ...
    click_context_menu_edit(host, port)
    time.sleep(2.0)
    from devkit.screenshots.lib.nav import _bp_eval
    _bp_eval(host, port, """
(function(){
