...
def _site_footer(prefix: str) -> str:
    ...
    return (
        ...
        'The same applies to every other plugin and theme mentioned on this site — including '
        'TabMaster, UnifiDeck, SteamGridDB, Non-Steam Badges, and any CSS Loader theme Deck Shelves '
        'detects or interoperates with: mentions are for interoperability only, not a claim of '
        'affiliation or endorsement by their respective authors.</div></div>'
        '<hr class="foot-rule">'
