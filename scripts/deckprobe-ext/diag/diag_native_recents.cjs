// Migrated from deckprobe's own diag/ during the toolkit's generic-vs-
// project-specific cleanup — this investigates DS's own recents-replace
// feature, not something the generic toolkit should carry.
var ws = require('ws');
