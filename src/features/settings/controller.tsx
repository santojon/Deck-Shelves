...
export function useSettingsController() {
  ...
  const [settings, setSettings] = useState<Settings | null>(() => getCurrentSettings() ?? { enabled: false, hideRecents: false, globalMatchNativeSize: false, globalHighlightFirst: false, shelves: [] });
