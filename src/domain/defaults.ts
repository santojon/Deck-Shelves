...
export function defaultSettings(): Settings {
  return {
    ...
    ownQamTabEnabled: false,
    showcaseModeEnabled: false,
    showcaseStartAfterSeconds: 60,
    showcaseDwellSeconds: 10,
    showcaseRandomize: false,
    showcaseStopOnInteraction: true,
    showcaseShelfIds: [],
    showcasePanCards: true,
    showcaseCardsPerShelf: 5,
    showcaseCardDwellSeconds: 4,
    qamHiddenToggles: [],
    qamHiddenSections: [],
