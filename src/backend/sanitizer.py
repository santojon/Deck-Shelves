...
def _preserve_unknown(raw: Dict[str, Any], known: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for key, value in raw.items():
        if not isinstance(key, str) or key in known or len(key) > 64:
            continue
