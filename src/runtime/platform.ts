...
export interface PlatformApi {
  ...
  resolveShelfAppIds(source: ShelfSource, limit: number, sort?: string, shelfId?: string, sortReverse?: boolean, options?: { hiddenAppIds?: number[]; dedupeByName?: boolean }): Promise<number[]>;
