...
`devkit/screenshots/scenarios/` and writes captures to
...
Usage:
    python3 -m devkit.screenshots.run \
...
if __name__ == "__main__" and __package__ is None:
    ...
    __package__ = "devkit.screenshots"
...
def main() -> int:  # noqa: C901
    ...
    parser.add_argument("--scenarios-dir", default=os.environ.get("SCREENSHOTS_SCENARIOS_DIR", ""),
                        help="Directory containing scenario *.py files using @register from devkit.screenshots.lib.registry.")
